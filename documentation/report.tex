...
\begin{document}
  ...
  \section{Context and state of the art}
    ...
    \subsection{Union-Find algorithms}
      ...
      \todo[color=blue!30,fancyline]{Reference}
    ...
    \subsection{Distributed algorithms}
      ...
      \citeA{ufdist09} introduced an parallization of the algorithm, based on an approach close to REM: the same kind of zigzag merge operation is done by comparing the rank of $r_x$ and $r_y$, where the rank is the depth of a node in its component's tree.
